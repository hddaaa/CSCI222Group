...
<table>
  ...
  <tr>
    ...
    <td><%=ParseDateUtil.formatDate(schedule.getDepartTime(), sourceAirport.getDatabase_timezone())%></td>
    <td><%=destinationAirport.getCity()%></td>
    <td><%=ParseDateUtil.formatDate(schedule.getArrivedTime(), destinationAirport.getDatabase_timezone())%></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><%=fleet.getAircraft()%></td>
    <td>available seat:<%=seatMap.getfClassSpare()%></td>
    <td>available seat:<%=seatMap.getbClassSpare()%></td>
    <td>available seat:<%=seatMap.getPeClassSpare()%></td>
    <td>available seat:<%=seatMap.geteClassSpare()%></td>
  </tr>
  <tr>
    <td>Price:</td>
